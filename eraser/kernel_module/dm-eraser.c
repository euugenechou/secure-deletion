...
static int eraser_map_bio(struct dm_target *ti, struct bio *bio)
{
	...
	bio->bi_iter.bi_sector = bio->bi_iter.bi_sector + (rd->rh->data_start * ERASER_SECTOR_SCALE);
...
/* /\* Command handlers. *\/ */
/* static int eraser_netlink_set_key(struct sk_buff *skb, struct genl_info *info) */
/* { */
/* 	DMCRIT("SET KEY RECEIVED"); */
/* 	return 0; */
/* } */

/* static int eraser_netlink_get_key(struct sk_buff *skb, struct genl_info *info) */
/* { */
